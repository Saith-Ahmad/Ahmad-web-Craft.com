...
export const navLinks = [
  ...
  export const testimonials = [
    
    {
      ...
      nationality: "UK",
      clientImage: client2,
      testimonial: "Working with Saith Ahmad was a game-changer for my real estate business. His dynamic web design brilliantly showcased our properties, leaving a lasting impression on potential buyers. The result? A significant increase in inquiries, viewings, and sales. Ahmad's professionalism and creativity set him apart.",
    },
    {
      client: "Lila Jason",
      nationality: "USA",
      clientImage: client3,
      testimonial: "Mr.Ahmad completely transformed the online presence of my restaurant. His user-friendly website design allowed new and existing customers to easily explore our menus, make reservations, and place orders. The result? Soaring sales and customer satisfaction. Ahmad's expertise and collaboration were invaluable.",
    },
    {
      client: "Mr. Waleed",
      nationality: "Pakistan",
      clientImage: client4,
      testimonial: "I owe the success of my e-commerce store to Ahmad's unparalleled expertise. His optimized website design not only increased traffic but also led to higher conversion rates. The result? A surge in sales that solidified my online store's position in the market. Ahmad's dedication and insight make him a true asset.",
    },
    {
      client: "Mr. Rahul",
      nationality: "India",
      clientImage: client1,
      testimonial: "Ahmad's innovative web development elevated my local business to new heights. His unique approach attracted a steady stream of new customers, boosting both our sales and credibility. His dedication and attention to detail are truly commendable.I would recommend him to others",
    },
  ];
  ...
  export const projects = [
    {
      title : "Netflix Clone",
      icon : netflix,
      link : "https://movix-13.netlify.app/"
    },
    {
      title : "Banking React App",
      icon : banking,
  ...
  export const contacts = [
    ...
    {
      name : "Twitter",
      url : "https://twitter.com/SaithAh70998774",
    },
    {
      name : "Instagram",
      url : "https://www.instagram.com/saith_ahmad_13/",
    },
    {
      name : "Email",
      url : "mailto:ahmadwebcrafts@gmail.com",
    },
  ]
